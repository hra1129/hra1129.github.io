...
enemy_boss5_move::
		...
		or		a, a
		jr		nz, enemy_boss5_move_active
enemy_boss5_inactive:
...
enemy_boss5_move_fire:
		; 弾を発射するタイミングか？
		ld		a, [ix + SCA_INFO_ENEMY_SHOT_TIMING]
		inc		a
		and		a, 15
		ld		[ix + SCA_INFO_ENEMY_SHOT_TIMING], a
		jr		nz, enemy_boss5_move_end					; 発射のタイミングでなければ enemy_boss5_move_end へ
		; 発射処理
		ld		iy, player_info
		call	enemy_shot_start
enemy_boss5_move_end:
enemy_boss5_move_dummy:
		ret
