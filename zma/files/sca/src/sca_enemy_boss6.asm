...
enemy_boss6_move::
		...
		or		a, a
		jr		nz, enemy_boss6_move_active
enemy_boss6_inactive:
...
enemy_boss6_move_fire:
		; 弾を発射するタイミングか？
		ld		a, [ix + SCA_INFO_ENEMY_SHOT_TIMING]
		inc		a
		and		a, 7
		ld		[ix + SCA_INFO_ENEMY_SHOT_TIMING], a
		jr		nz, enemy_boss6_move_end					; 発射のタイミングでなければ enemy_boss6_move_end へ
		; 発射処理
		ld		iy, player_info
		call	enemy_shot_start
enemy_boss6_move_end:
enemy_boss6_move_dummy:
		ret
